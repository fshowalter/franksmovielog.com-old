...
def _fields_to_credits(fields: List[Optional[str]], credit_index: int) -> List[CrewCredit]:
    ...
    for sequence, person_imdb_id in enumerate(str(fields[credit_index]).split(',')):
        crew_credits.append(CrewCredit(
