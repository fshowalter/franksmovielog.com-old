...
from movie_db.internal import table_base, watchlist
...
class WatchlistTitle(object):
    ...
    @classmethod
    def titles_for_item_type(cls, item_type: Type[watchlist.Base]) -> List['WatchlistTitle']:
