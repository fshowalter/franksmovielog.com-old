...
OptionType = Tuple[Optional[Callable[..., None]], HTML]


def radio_list(title: str, options: Sequence[OptionType]) -> Optional[Callable[..., None]]:
    ...
    return cast(Optional[Callable[..., None]], application.run())
